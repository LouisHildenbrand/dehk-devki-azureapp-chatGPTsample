        ...
        <div className={styles.container} role="main">
            {showAuthMessage ? (
                <Stack className={styles.chatEmptyState}>
                    ...
                    Für diese Anwendung ist keine Authentifizierung konfiguriert. Bitte fügen Sie einen Identity Provider hinzu, indem Sie Ihre App im 
                        <a href="https://portal.azure.com/" target="_blank"> Azure Portal </a>
                    auswählen und 
                         <a href="https://learn.microsoft.com/en-us/azure/app-service/scenario-secure-app-authentication-app-service#3-configure-authentication-and-authorization" target="_blank">diesen Anweisungen</a>
                     folgen.
                    </h2>
                    <h2 className={styles.chatEmptyStateSubtitle} style={{fontSize: "20px"}}><strong>Die Konfiguration der Authentifizierung nimmt einige Minuten in Anspruch. </strong></h2>
                    <h2 className={styles.chatEmptyStateSubtitle} style={{fontSize: "20px"}}><strong>Wenn Sie in den letzten 10 Minuten deployed haben, warten Sie bitte und laden Sie die Seite nach 10 Minuten erneut.</strong></h2>
                </Stack>
            ) : (
                <Stack horizontal className={styles.chatRoot}>
                    <div className={styles.chatContainer}>
                        ...
                        <Stack horizontal className={styles.chatInput}>
                            ...
                            <QuestionInput
                                clearOnSend
                                placeholder="Deine Frage an Hochland HistoryGPT..."
                                disabled={isLoading}
                                onSend={(question, id) => {
